...
//                    " is running");
            ...
            ratio = 0.75; // found to be better the higher it is
            createInitialPopulation(ratio);
            //data/time_series_covid_19_confirmed.csv
            List<CovidDataObject> data = tk.readCSV("data/time_series_covid_19_confirmed.csv");
